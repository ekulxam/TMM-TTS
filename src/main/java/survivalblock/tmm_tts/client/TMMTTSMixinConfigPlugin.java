...
public class TMMTTSMixinConfigPlugin implements IMixinConfigPlugin {
    @Override
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.contains("compat")) {
            if (mixinClassName.contains("ttvoice")) {
                return FabricLoader.getInstance().isModLoaded("ttvoice");
            }
